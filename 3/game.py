...
if __name__ == "__main__":
    try:
        optlist,args=getopt.getopt(sys.argv[1:],'vt:m:r')
    except getopt.error:
        print "Usage: python %s  {-r} {-v} {-t time} {-m runtime} player1 player2" % (sys.argv[0])
        exit()
    ...
    for i in range(runtime):
        ...
        if (len(res) == 4):
            ...
            tie+=1
        print 'result:',args[0],'wins',win[args[0]],args[1],'wins',win[args[1]],'tie',tie
