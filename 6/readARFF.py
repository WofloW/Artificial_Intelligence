...
def readArff(filehandle) :
    ...
    for index in range(len(attribLines)-1) :
        ...
        chunks = line.split(' ',2)    
        if chunks[2].strip().startswith('{') : ### this is a nominal attribute
...
if __name__ == '__main__' :
    ...
    print "Most common classification is: ", computeZeroR(data)
    # print getAttrList(attrs)
